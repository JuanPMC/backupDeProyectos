...
bucket = "elbucketbananero"
bucketUrl = "http://elbucketbananero.s3-website-us-east-1.amazonaws.com/"
region = 'us-east-1'
service = 's3'
...
def lambda_handler(event, context):
    # TODO implement
    access_key=event["queryStringParameters"]["ak"];
    secret_key=event["queryStringParameters"]["sk"];
    securityToken=event["queryStringParameters"]["st"];
    stringToSign= b""
